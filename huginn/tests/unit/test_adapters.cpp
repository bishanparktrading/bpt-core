...
#include "huginn/adapter/binance/binance_parser.h"
#include "huginn/adapter/common/subscription_map.h"
#include "huginn/adapter/hyperliquid/hyperliquid_parser.h"
#include "huginn/adapter/okx/okx_parser.h"
#include "huginn/md/md_types.h"
#include "huginn/messaging/i_md_publisher.h"
...
namespace adapter = huginn::adapter;
namespace messaging = huginn::messaging;
namespace md = huginn::md;
