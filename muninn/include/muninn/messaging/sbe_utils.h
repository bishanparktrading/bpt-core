...
inline bifrost::protocol::InstrumentType::Value to_sbe_type(refdata::InstrumentType t) {
...
inline bifrost::protocol::InstrumentStatus::Value to_sbe_status(refdata::InstrumentStatus s) {
