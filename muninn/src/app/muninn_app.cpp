...
#include "muninn/adapter/hyperliquid/hyperliquid_refdata_adapter.h"
#include "muninn/adapter/okx/okx_refdata_adapter.h"
...
uint8_t exchange_id_to_bit(bifrost::protocol::ExchangeId::Value id) {
    switch (id) {
        case bifrost::protocol::ExchangeId::BINANCE:
            return 0x01;
        case bifrost::protocol::ExchangeId::OKX:
            return 0x02;
        case bifrost::protocol::ExchangeId::HYPERLIQUID:
            return 0x04;
        case bifrost::protocol::ExchangeId::DERIBIT:
            return 0x08;
        default:
            return 0x00;
    }
...
MuninnApp::MuninnApp(config::Settings settings,
    ...
    status_pub_ = std::make_shared<messaging::MuninnStatusPublisher>(aeron,
                                                                     settings_.muninn_status.channel,
                                                                     settings_.muninn_status.stream_id);
...
void MuninnApp::run() {
    ...
    while (ygg::signal::is_running()) {
        ...
        if (now - last_muninn_ready >= muninn_ready_interval) {
