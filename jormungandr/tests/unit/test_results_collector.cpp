// Unit tests for jormungandr::results::ResultsCollector
...
using namespace jormungandr::results;
using namespace jormungandr::matching;
using namespace jormungandr::data;

// ── Helpers ───────────────────────────────────────────────────────────────────

static FillReport make_fill(OrderSide side, double qty, double price,
