...
Settings load(const std::string& path) {
    ygg::log::info("[Jormungandr] Loading config from: {}", path);
    ...
    ygg::log::info("[Jormungandr] Backtest window: {} → {}", s.simulation.start, s.simulation.end);
    ygg::log::info("[Jormungandr] Instruments: {}", s.instruments.size());
