...
#include "surtr/surface/vol_surface_grid.h"
...
public:
    ...
    void set_spot(const std::string& underlying, bifrost::protocol::ExchangeId::Value exchange_id, double spot_price);
...
private:
    ...
    static std::string curve_key(bifrost::protocol::ExchangeId::Value ex, const std::string& underlying);
};
