...
private:
    ...
    void send_leg_order(ArbPair& pair, LegState& leg, bifrost::protocol::OrderSide::Value side, uint64_t qty);
    void handle_fill(ArbPair& pair, const LegState& leg, const bifrost::protocol::ExecutionReport& rpt);
    void handle_terminal(ArbPair& pair, LegState& leg, bifrost::protocol::ExecStatus::Value status);
