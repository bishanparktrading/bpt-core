...
#include "fenrir/strategy/hmm_filter.h"
...
private:
    ...
    struct InstrumentState {
        ...
        bifrost::protocol::OrderSide::Value momentum_side{bifrost::protocol::OrderSide::BUY};
        uint64_t momentum_order_id{0};

        // ── VWAP reversion sub-strategy ──────────────────────────────────────
        bool has_reversion_position{false};
        bifrost::protocol::OrderSide::Value reversion_side{bifrost::protocol::OrderSide::BUY};
