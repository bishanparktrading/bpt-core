...
private:
    ...
    struct GridLevel {
        uint64_t order_id{0};
        double price{0.0};
        bifrost::protocol::OrderSide::Value side{bifrost::protocol::OrderSide::NULL_VALUE};
    ...
    struct InstrumentState {
        ...
        bifrost::protocol::OrderSide::Value momentum_side{bifrost::protocol::OrderSide::NULL_VALUE};
    ...
    void grid_on_fill(InstrumentState& st, uint64_t order_id, const bifrost::protocol::ExecutionReport& rpt);
