...
void OrderGatewayClient::send_cancel_all(bifrost::protocol::ExchangeId::Value exchange_id, uint64_t instrument_id) {
    using namespace bifrost::protocol;
...
void OrderGatewayClient::send_account_snapshot_request(bifrost::protocol::ExchangeId::Value exchange_id,
