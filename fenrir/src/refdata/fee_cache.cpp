...
void FeeCache::update(bifrost::protocol::ExchangeId::Value exchange_id,
...
std::optional<FeeScheduleEntry> FeeCache::get(bifrost::protocol::ExchangeId::Value exchange_id,
                                              uint64_t instrument_id,
