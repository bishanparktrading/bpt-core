...
public:
    ...
    static BacktestCommand::Value get(const std::uint8_t value)
    {
        switch (value)
        {
            case static_cast<std::uint8_t>(0): return START;
            case static_cast<std::uint8_t>(1): return STOP;
            case static_cast<std::uint8_t>(2): return RESET;
    ...
    friend std::basic_ostream<CharT, Traits> & operator << (
        std::basic_ostream<CharT, Traits> &os, BacktestCommand::Value m)
    {
