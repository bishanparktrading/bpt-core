...
#ifndef _BPT_MESSAGES_FEECURRENCY_CXX_H_
#define _BPT_MESSAGES_FEECURRENCY_CXX_H_
...
public:
    ...
    static FeeCurrency::Value get(const std::uint8_t value)
    {
        switch (value)
        {
            case static_cast<std::uint8_t>(0): return USDT;
            case static_cast<std::uint8_t>(1): return BTC;
            case static_cast<std::uint8_t>(2): return ETH;
            case static_cast<std::uint8_t>(3): return BNB;
            case static_cast<std::uint8_t>(4): return USD;
    ...
    friend std::basic_ostream<CharT, Traits> & operator << (
        std::basic_ostream<CharT, Traits> &os, FeeCurrency::Value m)
    {
